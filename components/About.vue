      ...
      <div class="relative px-6 lg:px-8">
        <div class="mx-auto max-w-prose text-lg">
          ...
          <div class="prose prose-lg prose-yellow mx-auto mt-6 text-gray-500">
            <p>Desde nuestros inicios, hemos trazado un extraordinario camino en la fabricación y la ingeniería industrial. Comenzamos con piezas claves como ejes y engranajes, sumando mantenimiento y creación de estructuras sólidas.</p><br />

          <p>Nuestra destreza artesanal nos impulsó a abordar un desafío único en Chile: diseñar y fabricar una máquina para imprimir etiquetas autoadhesivas en envases de vino, una tarea previamente considerada inalcanzable debido a su complejidad y costos. Esta proeza no solo demostró nuestra capacidad técnica, sino también nuestra voluntad de encontrar soluciones innovadoras.</p><br />
          ...
          <p>
            Hoy, somos un testimonio de la pasión por la ingeniería y fabricación. Nuestra historia resalta logros, superación y colaboración con líderes industriales, elevando la eficiencia y la innovación en la producción. Somos más que una empresa; somos la encarnación de cómo los desafíos nos impulsan a crecer y cómo la creatividad puede superar los límites.
          </p>
        </div>          
        </div>
      </div>
