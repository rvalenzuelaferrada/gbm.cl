...
<template>
    <div id="inicio" class="relative isolate overflow-hidden bg-gray-900">
      <img src="/images/slide02.jpg" alt="" class="absolute inset-0 -z-10 h-full w-full object-cover opacity-40" />
        ...
        <nav class="flex items-center justify-between pt-6" aria-label="Global">
          <div class="flex lg:flex-1">
            ...
            <a href="#" class="-m-1.5 p-1.5">
              ...
              <img class="h-8" src="https://tailwindui.com/img/logos/mark.svg?color=yellow&shade=500" alt="" />
            </a>
            -->
          </div>
            ...
            <div class="mt-6 flow-root">
              <div class="-my-6 divide-y divide-gray-500/25">
                <div class="space-y-2 py-6">
                  <a v-for="item in navigation" @click="mobileMenuOpen = false" :key="item.name" :href="item.href" class="-mx-3 block rounded-lg py-2 px-3 text-base font-semibold leading-7 text-white hover:bg-gray-400/10">{{ item.name }}</a>
                </div>
                <!--
                <div class="py-6">
