...
<template>
    <div id="contacto" class="bg-gray-100">
          ...
          <div class="grid grid-cols-1"><!-- lg:grid-cols-3 -->
            ...
            <div class="relative overflow-hidden bg-yellow-700 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <dl class="mt-8 space-y-6">
                ...
                <dd class="flex text-base text-yellow-50">
                  <EnvelopeIcon class="h-6 w-6 flex-shrink-0 text-yellow-200" aria-hidden="true" />
            ...
            <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
              ...
              <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                <div>
                  ...
                  <div class="mt-1">
                    <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="block w-full rounded-md border-gray-300 py-3 px-4 text-gray-900 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" />
                  </div>
                </div>
                <div>
                  <label for="last-name" class="block text-sm font-medium text-gray-900">Apellido</label>
                  <div class="mt-1">
                    <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="block w-full rounded-md border-gray-300 py-3 px-4 text-gray-900 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" />
                  </div>
                </div>
                <div>
                  <label for="email" class="block text-sm font-medium text-gray-900">Email</label>
                  <div class="mt-1">
                    <input id="email" name="email" type="email" autocomplete="email" class="block w-full rounded-md border-gray-300 py-3 px-4 text-gray-900 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" />
                  </div>
                </div>
                <div>
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="mt-1">
                    <input type="text" name="subject" id="subject" class="block w-full rounded-md border-gray-300 py-3 px-4 text-gray-900 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" />
                  </div>
                </div>
                <div class="sm:col-span-2">
                  <div class="flex justify-between">
                ...
                <div class="sm:col-span-2 sm:flex sm:justify-end">
                  <button type="submit" class="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto">Enviar Mensaje</button>
                </div>
              </form>
            </div>
            -->
